...
Функция ОбработатьВходящееСообщение(ДанныеТела)
	//
КонецФункции
//
Функция ОбработатьДоставкуСообщения(ДанныеТела)
	//
КонецФункции	
//
Функция ОбработатьЧтениеСообщения(ДанныеТела)
	//
КонецФункции
//
Функция ОбработатьОтключениеКлиента(ДанныеТела)
	//
КонецФункции
//
Функция ОбработатьОшибку(ДанныеТела)
	//
КонецФункции
